...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        if self.use_wandb:
            self.wandb_run = wandb.init(project='CycleGAN_pix2pix', name=opt.name, config=opt) if not wandb.run else wandb.run
            self.wandb_run._label(repo='CycleGAN_pix2pix')
